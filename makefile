...
LOVE_VERSION=11.2
NAME=mari0
URL=https://github.com/alexjgriffith/mari0
AUTHOR="Alexnader Griffith"
DESCRIPTION="Mario + Portal Gun"
LUA := $(wildcard *.lua)
RESOURCES="sounds shaders mappacks netplayinc graphics"
...
$(LOVEFILE): $(LUA) sounds shaders mappacks netplayinc graphics
	mkdir -p releases/
